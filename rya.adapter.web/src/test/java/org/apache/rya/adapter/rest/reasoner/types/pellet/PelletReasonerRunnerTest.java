...
/**
 * Tests the methods of {@link PelletReasonerRunner}.
 */
public class PelletReasonerRunnerTest extends MongoITBase {
    ...
    @Test
    public void testPelletReasonerRunner() throws Exception {
        final PelletReasonerRunner pelletReasonerRunner = new PelletReasonerRunner();

        final String namespace = "http://owldl.com/ontologies/dl-safe.owl#";
        final Statement inferredStmt = createStatement("Cain", "sibling", "Abel", namespace);

        final String filename = "src/test/resources/data/dl-safe.owl";
        final ReasonerResult reasonerResult = pelletReasonerRunner.runReasoner(repository, filename);
        ...
        assertEquals(292, ryaStatements.size());
